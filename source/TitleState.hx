...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		credTextShit = new Alphabet(0, 0, "shpeelos\nbloxiam is trash", true);
	...
	override function beatHit()
	{
		...
		{
			case 1:
				createCoolText(['shpeelos', 'blosiam is trash']);
			...
			case 5:
				if (Main.watermarks)
					createCoolText(['quereno pasas el bloxiam', 'tu siman']);
				else
			...
			// credTextShit.text += '\nNight';
			case 15:
				addMoreText('beat drop LOL'); // credTextShit.text += '\nFunkin';
